...
public class Conductores extends Trabajadores{
    private String tipoCarnet;
    private LocalDate caducidadCarnet;
    private double sueldoBase;
    private double kilometros;

    public Conductores(int id, String nombre, LocalDate fechaNacimiento, String tipoCarnet, LocalDate caducidadCarnet, double sueldoBase, double kilometros) {
    ...
    public String toString() {
        return super.toString() + "Conductores{" +
